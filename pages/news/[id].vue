  ...
  <div class="news-page">
    ...
    <div class="social-share-fixed">
      ...
      <div v-if="showCopyNotification" class="copy-notification">
        <div class="copy-notification__content">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M13.3333 4L6 11.3333L2.66667 8" stroke="white" stroke-width="2" stroke-linecap="round"
      ...
      <button class="social-share__button" @click="shareVK">
        <div class="social-share__icon">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="asideShare__svg_xoSH6">
            <path
        ...
        <div class="news-article__content">
          ...
          <div class="news-article__meta">
            <div class="news-article__date">
              <span class="date-number">{{ newsItem.number || newsItem.day || new Date(newsItem.createdAt).getDate()
                }}</span>
          ...
          <div class="news-article__text">
            ...
            <template v-if="newsItem.blocks && newsItem.blocks.length > 0">
              <div v-for="(block, index) in newsItem.blocks" :key="index" class="news-block">
                <!-- Текстовый блок -->
                <div v-if="block.__component === 'element-news.tekst'" class="news-block__text"
                  v-html="formatMarkdown(block.text)"></div>

                <!-- Фото или видео -->
                <div v-else-if="block.__component === 'element-news.foto-ili-video' && block.value"
                  class="news-block__media">
                  <img v-if="block.value.url" :src="getMediaUrl(block.value)"
                    :alt="block.value.alternativeText || newsItem.title" loading="lazy" />
                </div>
              </div>
            </template>
    ...
    <section v-if="newsItem" class="other-news-section">
      <div class="other-news-section__container container">
        ...
        <DefaultSlider :slides="otherNews" :slides-per-view="2" :space-between="45" :show-navigation="true"
...
.news-page {
  ...
  padding-top: 0;
  /* Убираем отступ сверху, так как есть хедер */
}
...
@media (max-width: 768px) {
  .news-page {
    padding: 0;
    /* Убираем отступы, так как используем flex */
  }
  ...
  .news-article {
    padding: 0;
    margin: 70px 0 0;
    /* Уменьшенный отступ снизу на мобильных */
  }
  ...
  .other-news-section {
    ...
    /* Уменьшенный отступ на мобильных */
